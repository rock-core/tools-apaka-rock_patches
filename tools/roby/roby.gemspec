...
Roby.
  ...
  s.files         = `git ls-files -z`.split("\x0").reject { |f| f.match(%r{^(test|spec|features)/}) || !File.exist?(f) }

  s.add_runtime_dependency "facets", "~> 3.1"
  s.add_runtime_dependency "utilrb", "~> 3.0"
  s.add_runtime_dependency "state_machine", "= 1.0.3"
  s.add_runtime_dependency "metaruby", '~> 1.0'
  s.add_runtime_dependency "rgl", '~> 0.5.0', '>= 0.5.1'
  ...
  s.add_runtime_dependency "pastel", '~> 0.5.0', '>= 0.5.2'
